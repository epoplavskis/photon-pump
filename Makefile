...
eventstore_docker:
	docker run -d --name eventstore_local -p 2113:2113 -p 1113:1113  -e EVENTSTORE_DEV=true eventstore/eventstore
	docker run -d --name eventstore_local_noauth -p 22113:2113 -p 11113:1113  -e EVENTSTORE_DEV=true eventstore/eventstore
